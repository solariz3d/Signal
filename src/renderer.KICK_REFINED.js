...
const flowProg = mkP(
  ...
  `precision highp float;
   ...
   void main() {
     ...
     // Center perturbation — smoothstep falloff for clean gradient
     float centerWeight = smoothstep(0.32, 0.0, rad);
     centerWeight = centerWeight * centerWeight * (3.0 - 2.0 * centerWeight);
     float centerChurn = centerWeight * (uBass * 1.9 + uOnset * 2.85);
