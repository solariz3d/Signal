...
// Same absorption math as the original Signal
function absorbValue(v) {
  soul.seed += v * 0.0000137508;
  soul.hue1 = (soul.hue1 + v * 0.0007) % 1.0;
  soul.hue2 = (soul.hue2 + (v * v) * 0.0000003) % 1.0;
  soul.hue3 = (soul.hue3 + (v & 0x3F) * 0.00015) % 1.0;
}
