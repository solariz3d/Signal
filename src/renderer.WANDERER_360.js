  ...
  `precision highp float;
   ...
   void main() {
     ...
     for (int i = 0; i < 40; i++) {
       ...
       if (density < 0.10) continue;  // sparser than before but still visible
       density = smoothstep(0.10, 0.40, density) * 0.75;
     ...
     // Everything fades to black when no bass — smooth gate
     float worldGate = smoothstep(0.03, 0.2, uBass);
     col *= worldGate;
